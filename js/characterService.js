...
(function() {
    ...
    //create DOM module
    var m = darlingjs.module('charServiceModule', []);
    ...
    m.$system('characterService', {
        ...
        $added: function() {
            ...
            if (!this.stageElement) {
                throw new Error('can\'t find ' + this.target + ' as stage for character table')
            }

            $('<tr class="item_header" style="background-color:#848484" id=item_bar></tr>').appendTo(this.target);
