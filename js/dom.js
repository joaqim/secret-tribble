...
(function() {
    ...
    m.$system('domViewRenderer', {
        ...
        $require: ['ng2D', 'ng2DSize', 'domView', 'character', 'status'],
        ...
        $added: function() {
            ...
            if (!this.stageElement) {
                throw new Error('can\'t find ' + this.target + ' as stage for dom renderer')
            }
        ...
        $addEntity: ['$entity', function($entity) {
            ...
            p.innerHTML= 'Name: '+character.aName +', son of '+ character.father + '<br>';
            ...
            nameDiv.style.right = '25%';
            nameDiv.style.left = '50%';

            var txt = document.createTextNode(character.aName);
